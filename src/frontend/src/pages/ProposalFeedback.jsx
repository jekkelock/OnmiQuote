  ...
  if (submitted) return (
    <div className="min-h-screen bg-slate-100 flex items-center justify-center px-4">
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-10 text-center max-w-md w-full">
        ...
        <h2 className="text-xl font-bold text-slate-900 mb-2">Revision Request Submitted</h2>
        <p className="text-slate-500 text-sm">
          Thank you! Your notes have been recorded and the team has been notified.
          They'll be in touch shortly.
        </p>
        <a href={`/proposal/${hash}`} className="inline-block mt-6 text-blue-600 text-sm font-medium hover:underline">
          ← Back to proposal
        </a>
      </div>
    </div>
    ...
    <div className="min-h-screen bg-slate-100 py-10 px-4">
      <div className="max-w-xl mx-auto">
        ...
        <div className="mb-6 text-center">
          <p className="text-lg font-bold text-slate-900">OmniQuote</p>
          <p className="text-sm text-slate-500 mt-0.5">Request a Revision</p>
        </div>

        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8">
          <h1 className="text-xl font-bold text-slate-900 mb-1">Request Revision</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <textarea
                ...
                required
              />
              <p className="text-xs text-slate-400 mt-1">{feedbackText.length} characters</p>
            </div>
          ...
          <div className="mt-6 pt-4 border-t border-slate-100 text-center">
            <a href={`/proposal/${hash}`} className="text-slate-400 text-xs hover:text-slate-600 hover:underline">
              ← Back to proposal
            </a>
          </div>
        </div>
